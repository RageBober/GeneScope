...
from typing import Literal, overload, Union, cast
...
def get_outlier_mask(
    ...
    *,
    ...
    if df.empty:
        ...
        return cast(
            "Union[BoolSeries, BoolFrame]",  # mypy OK
    ...
    if method in ("iqr", "z-score"):
        ...
        return cast("Union[BoolSeries, BoolFrame]", mask_df[cols[0]] if column else mask_df)
