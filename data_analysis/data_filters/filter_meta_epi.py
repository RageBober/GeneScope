...
def filter_by_cpg_confidence(
    ...
    if coverage_col in filtered_df.columns:
        ...
        print(
            f"[filter_by_cpg_confidence] Колонка '{coverage_col}' не найдена, пропускаем coverage-фильтр."
        )
    ...
    if pvalue_col in filtered_df.columns:
        ...
        print(
            f"[filter_by_cpg_confidence] Колонка '{pvalue_col}' не найдена, пропускаем p-value-фильтр."
        )
